  ...
  const sections = [
    {
      ...
      body: 'ระบบอาจจัดเก็บข้อมูลบัญชี เช่น ชื่อผู้ใช้ ชื่อจริง อีเมล เบอร์โทรศัพท์ รูปโปรไฟล์ Role ของผู้ใช้ รวมถึงข้อมูลคำสั่งซื้อและรายการอาหารที่เกี่ยวข้องกับบัญชีของคุณ',
    },
    {
    ...
    },
    {
      ...
      body: 'Admin สามารถดูข้อมูลที่จำเป็นต่อการจัดการระบบ Owner และ Staff จะเข้าถึงข้อมูลออเดอร์เฉพาะร้านที่ได้รับสิทธิ์เท่านั้น',
    },
    {
    ...
    },
    {
      ...
      body: 'ผู้ใช้สามารถแก้ไขข้อมูลโปรไฟล์ของตนเองได้ในหน้าบัญชี หากพบข้อมูลผิดพลาดหรือมีข้อสงสัยเกี่ยวกับข้อมูลส่วนตัว สามารถติดต่อ Admin ได้',
    },
  ]
  ...
  return (
    <div className="mx-auto max-w-4xl px-0 py-4 text-white sm:px-4 sm:py-12">
      <section className="rounded-2xl border border-neutral-800  p-4 shadow-2xl sm:p-6 md:p-8">
        <p className="text-sm font-bold uppercase tracking-wide text-amber-400">นโยบายความเป็นส่วนตัว</p>
        <h1 className="mt-3 text-2xl font-black sm:text-3xl md:text-4xl">นโยบายความเป็นส่วนตัว</h1>
        <p className="mt-4 text-sm leading-7 text-neutral-400">
          นโยบายนี้อธิบายว่าระบบฟู้ดออเดอร์ KMUTNB จัดเก็บ ใช้งาน และปกป้องข้อมูลของผู้ใช้อย่างไร
