    ...
    <div className="flex flex-col w-full px-4 sm:max-w-md justify-center gap-2 mt-12 mx-auto text-white">
      ...
      <div className=" border border-neutral-900 rounded-2xl p-6 sm:p-8 shadow-2xl w-full">
        ...
        >
          ...
          <input
            className="rounded-md px-4 py-2.5  border border-neutral-800 mb-4 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 text-white placeholder:text-neutral-600 transition-all text-sm"
            name="email"
            type="email"
          ...
          <div className="relative mb-6">
            <input
              className="w-full rounded-md pl-4 pr-14 py-2.5  border border-neutral-800 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 text-white placeholder:text-neutral-700 transition-all text-sm"
          ...
          {turnstileSiteKey && (
            <div className="mb-4 flex min-h-[65px] w-full items-center justify-center overflow-hidden rounded-md border border-neutral-800 ">
              <div
          ...
          <label className="mb-4 flex cursor-pointer items-center gap-2 text-xs font-semibold text-neutral-400 transition-colors hover:text-orange-400">
            <input
              ...
              className="h-4 w-4 rounded border-neutral-700  text-orange-500 accent-orange-500"
            />
          ...
          <Link
            ...
            className="border border-neutral-800 rounded-md px-4 py-2.5 text-neutral-400 text-center  hover:text-orange-500 hover:border-orange-500 transition-all font-bold text-sm"
          >
            {isOpeningRegister ? 'กำลังเปิดหน้าสมัครสมาชิก...' : 'สมัครสมาชิก'}
          </Link>
